...
groupSubjectActivityData <- group_by(finalData, SubjectCode, ActivityLabel)
...
write.csv(summarizedFinalData, file = "summarizedFinalTable.csv", row.names=FALSE)
write.table(summarizedFinalData, file = "summarizedFinalTable.txt", row.name=FALSE) 
